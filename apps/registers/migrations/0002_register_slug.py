...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Register.slug'
        db.add_column(u'registers_register', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Register.slug'
        db.delete_column(u'registers_register', 'slug')
    ...
    models = {
        ...
        u'registers.register': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['registers.Tag']", 'null': 'True', 'blank': 'True'}),
